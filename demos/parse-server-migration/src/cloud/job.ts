...
Parse.Cloud.afterSave("CaskSubCreate", async function (request : any) {
...
Parse.Cloud.afterSave("CaskSubRenewal", async function (request : any) {
  scheduler.recreateSchedule(request.object.id);
...
//cask sub cancel
Parse.Cloud.afterSave("CaskSubBurn", async function (request : any) {
  scheduler.recreateSchedule(request.object.id);
